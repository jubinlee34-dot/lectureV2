...
export function LectureCard({ lecture, onClick, onEdit, onDelete, onManage, onSms }: LectureCardProps) {
  ...
  return (
    <div
      className="group relative cursor-pointer rounded-lg border border-border bg-card p-4 transition-all hover:border-primary/40 hover:shadow-sm"
